 ...
 * options above.
 */
// Santosh Kore - Wrapped function inside document ready event
$(document).ready(function() {
    $(function() {
        ...
        if (o.enableBSToppltip) {
            // Santosh Kore - Getting errors if there is no element with data-toggle="tooltip"
            if ($(o.BSTooltipSelector) && $(o.BSTooltipSelector).length) {
